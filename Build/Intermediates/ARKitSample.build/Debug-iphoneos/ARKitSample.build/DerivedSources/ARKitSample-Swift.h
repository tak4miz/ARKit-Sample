...
SWIFT_MODULE_NAMESPACE_PUSH("ARKitSample")


@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC11ARKitSample11AppDelegate")
...
SWIFT_CLASS("_TtC11ARKitSample11PictureNode")
@interface PictureNode : SCNNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ARKitSample9PlaneNode")
...
SWIFT_CLASS("_TtC11ARKitSample14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(ARKitSample)) <ARSessionDelegate>
...
@interface ViewController (SWIFT_EXTENSION(ARKitSample)) <ARSCNViewDelegate>
...
@interface ViewController (SWIFT_EXTENSION(ARKitSample))
